...
(function ($) {
   ...
   $(".product-slider").owlCarousel({
    ...
    /*-------------------
		Radio Btn
	--------------------- */
    $(".fw-size-choose .sc-item label, .pd-size-choose .sc-item label, .pd-color-choose .cc-item label").on('click', function () {
        $(".fw-size-choose .sc-item label, .pd-size-choose .sc-item label, .pd-color-choose .cc-item label").removeClass('active');
