            ...
            <div class="ht-right">
                ...
                <div class="lan-selector">
                    <select class="language_drop" name="countries" style="width: 300px;">
                        <option value="yt"
                                data-image="client/img/english.png"
                                data-imagecss="flag yt"
                                data-title="English">English
                        </option>
                        <option value="yu"
                                data-image="client/img/vietnam.png"
        ...
        <div class="inner-header">
            <div class="row">
                <div class="col-lg-2 col-md-2">
                    <div class="logo">
                        <a href="index.html">
                            <img src="client/img/logo.png" height="25" alt="">
                        </a>
                    </div>
                </div>
                            ...
                            <div class="cart-hover">
                                <div class="select-items">
                                    <table class="table">
                                        <tbody>
                                        <tr>
                                            <td class="si-pic"><img src="client/img/select-product-1.jpg" alt=""></td>
                                            <td class="si-text">
